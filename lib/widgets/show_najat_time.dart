...
class ShowNajatTime extends StatefulWidget {
  String division;
  int increase;
  ShowNajatTime({Key? key, required this.division, required this.increase})
      : super(key: key);

  @override
  State<ShowNajatTime> createState() => _ShowNajatTime();
}

class _ShowNajatTime extends State<ShowNajatTime> {
